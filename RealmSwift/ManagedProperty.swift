...
public protocol RealmValue {
    static func _rlmGetProperty(_ obj: ObjectBase, _ key: UInt16) -> Self
    static func _rlmGetPropertyOptional(_ obj: ObjectBase, _ key: UInt16) -> Self?
    static func _rlmSetProperty(_ obj: ObjectBase, _ key: UInt16, _ value: Self)
}
...
public struct ManagedProperty<Value: RealmValue>: _ManagedPropertyProtocol {
    ...
    public static subscript<EnclosingSelf: ObjectBase, FinalValue>(
        ...
        set {
            ...
            } else if RLMObjectBaseRealm(observed) != nil {
...
extension ManagedProperty: _ManagedPropertyType where Value: _ManagedPropertyType {
